...
<div class="col-xs-12 remove-pad-marg">
	<div class="right-section-container" style="background-image: url(<?php echo home_url(); ?>/wp-content/uploads/2016/07/cidea-logo-swirl-svg.png)">
		...
		<div class="centered-container">
			<div class="centered">
				<div class="middle-section-title scrollTime" data-animation="slideUpAnimation" data-timeout="200">
					<?php echo get_field('right_section_title'); ?>
				</div>
				<div class="middle-section-paragraph scrollTime" data-animation="slideRightAnimation" data-timeout="600">
		...
		<div class="centered-container">
			<div class="centered">
				<ul class="how-we-help-ul">
					<li class="scrollTime" data-animation="fadeInSlow"><?php echo get_field('how_we_help_point_1'); ?></li>
					...
					<li class="scrollTime" data-animation="fadeInSlow" data-timeout="400"><?php echo get_field('how_we_help_point_2'); ?></li>
					...
					<li class="scrollTime" data-animation="fadeInSlow" data-timeout="1200"><?php echo get_field('how_we_help_point_4'); ?></li>
				</ul>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xlg-12 remove-pad-marg">
	<div class="bottom-section-container" style="background-image: url(<?php echo get_field('bottom_section_image')['url']; ?>);">
		<div class="centered-container">
			<div class="centered">
				<div class="bottom-section-title scrollTime" data-animation="slideUpAnimation" data-timeout="500">
					<?php echo get_field('bottom_section_title'); ?>
				</div>
				<object data="<?php echo home_url(); ?>/wp-content/uploads/2016/07/svg-logo-swirl-transparent.svg" type="image/svg+xml" class="scrollTime" data-animation="rotateInAnimation" data-timeout="1000">
				...
				<a href="<?php echo home_url(); ?>/who-we-are">
					<div class="cidea-button scrollTime" data-animation="slideUpAnimation" data-timeout="500">
						<div class="centered-container">
							<div class="centered">
								Who We Are
							</div>
