...
<div class="second-section-container">
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xlg-6 remove-pad-marg">
		<div class="business-case-cont bg" style="background-image: url(<?php echo get_field('business_case_section_one_image')['url']; ?>)"></div>
	</div>
	...
	<div class="col-xs-12 col-sm-12 col-md-pull-6 col-md-6 col-lg-pull-6 col-lg-6 col-xlg-pull-6 col-xlg-6 remove-pad-marg">
		<div class="business-case-cont bg" style="background-image: url(<?php echo get_field('business_case_section_two_image')['url']; ?>)"></div>
	</div>
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xlg-6 remove-pad-marg">
		<div class="business-case-cont bg" style="background-image: url(<?php echo get_field('business_case_section_three_image')['url']; ?>)"></div>
	</div>
